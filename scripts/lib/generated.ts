...
export const generatedEnvPath = (svc: string): string =>
  resolve(STACK_DIR, svc, ".generated.env");
...
export const generatedGet = (svc: string, key: string): string =>
  envGet(generatedEnvPath(svc), key);
