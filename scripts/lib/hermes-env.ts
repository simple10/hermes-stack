...
export const MANAGED_OPEN = "# >>> hermes-stack managed (rewritten on each `stack-cli build`) -- DO NOT EDIT >>>";
export const MANAGED_CLOSE = "# <<< hermes-stack managed <<<";
const MANAGED_HINT = "# User vars below are preserved across `stack-cli build`. Add plugin env (e.g. HERMES_AGENTS_OBSERVE_URL) here.";
