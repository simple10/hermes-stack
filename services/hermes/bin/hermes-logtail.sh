...
tail -n0 -F /home/joe/.hermes/logs/gateway.log 2>/dev/null | sed -u "s/^/[hermes-gateway] /" > /dev/console &
tail -n0 -F /home/joe/.hermes/logs/errors.log  2>/dev/null | sed -u "s/^/[hermes-errors] /"  > /dev/console &
wait
