...
import { TaskListResponse, TaskDetailResponse, TaskCreateResponse, TaskPatchResponse } from '../schemas/tasks.ts';
...
const ROUTE_SCHEMAS: Array<{ method: string; pattern: RegExp; schema: z.ZodTypeAny }> = [
  ...
  { method: 'GET',  pattern: new RegExp(`^${PREFIX}/agents/[^/]+$`),                       schema: z.object({ agent: Agent }) },
  { method: 'PATCH',pattern: new RegExp(`^${PREFIX}/agents/[^/]+$`),                       schema: z.object({ agent: Agent }) },
  { method: 'POST', pattern: new RegExp(`^${PREFIX}/agents/[^/]+/rotate-key$`),            schema: AgentRotateKeyResponse },

  { method: 'GET',  pattern: new RegExp(`^${PREFIX}/connectors$`),                         schema: ConnectorListResponse },
  { method: 'POST', pattern: new RegExp(`^${PREFIX}/connectors$`),                         schema: ConnectorCreateResponse },
  { method: 'GET',  pattern: new RegExp(`^${PREFIX}/connectors/[^/]+$`),                   schema: z.object({ connector: Connector }) },
  { method: 'PATCH',pattern: new RegExp(`^${PREFIX}/connectors/[^/]+$`),                   schema: z.object({ connector: Connector }) },
  { method: 'POST', pattern: new RegExp(`^${PREFIX}/connectors/[^/]+/rotate-key$`),        schema: ConnectorRotateKeyResponse },

  { method: 'GET',  pattern: new RegExp(`^${PREFIX}/projects$`),                           schema: ProjectListResponse },
  { method: 'POST', pattern: new RegExp(`^${PREFIX}/projects$`),                           schema: z.object({ project: Project }) },
  { method: 'GET',  pattern: new RegExp(`^${PREFIX}/projects/[^/]+$`),                     schema: z.object({ project: Project }) },
  { method: 'PATCH',pattern: new RegExp(`^${PREFIX}/projects/[^/]+$`),                     schema: z.object({ project: Project }) },
  ...
  { method: 'GET',  pattern: new RegExp(`^${PREFIX}/tasks/[^/]+/comments$`),               schema: CommentListResponse },
  { method: 'POST', pattern: new RegExp(`^${PREFIX}/tasks/[^/]+/comments$`),               schema: CommentCreateResponse },

  { method: 'GET',  pattern: new RegExp(`^${PREFIX}/events$`),                             schema: EventListResponse },

  { method: 'GET',  pattern: new RegExp(`^${PREFIX}/external_refs$`),                      schema: ExternalRefListResponse },
