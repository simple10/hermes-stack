  ...
  return (
    <div className="space-y-8 max-w-2xl">
      <header>
        ...
        <p className="text-xs text-muted-foreground mt-1">ID: <code>{orgId}</code></p>
      </header>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input id="slug" onChange={(e) => setSlug(e.target.value)} pattern="[a-z0-9-]+" placeholder="new-slug" />
        </div>
      ...
      <section className="space-y-4 border-t pt-6">
        ...
        <AlertDialog>
          <AlertDialogTrigger asChild><Button variant="destructive">Delete organization</Button></AlertDialogTrigger>
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>Delete this organization?</AlertDialogTitle>
              <AlertDialogDescription>
                This is irreversible. All agents, connectors, projects, and tasks under this org will be removed.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
